...
TEST_F(SchemaTest, TestTagAndEdge) {
    ...
    }
    {
        ...
        ASSERT_TRUE(verifyResult(resp, expected, true, {0, 2, 3, 4, 5, 6}));
    }
    ...
    // Test multi sentence
    {
        ...
        ASSERT_TRUE(verifyResult(resp, expected1, true, {0, 2, 3, 4, 5, 6}));
        ...
        ASSERT_TRUE(verifyResult(resp, expected2, true, {0, 2, 3, 4, 5, 6}));
