...
TEST(Scanner, Basic) {
    ...
    std::vector<Validator> validators = {
        ...
        CHECK_SEMANTIC_TYPE("alter", TokenType::KW_ALTER),
        CHECK_SEMANTIC_TYPE("STEP", TokenType::KW_STEP),
        CHECK_SEMANTIC_TYPE("step", TokenType::KW_STEP),
        ...
        CHECK_SEMANTIC_TYPE("Lookup", TokenType::KW_LOOKUP),
        CHECK_SEMANTIC_TYPE("lookup", TokenType::KW_LOOKUP),
        CHECK_SEMANTIC_TYPE("SCAN", TokenType::KW_SCAN),
        CHECK_SEMANTIC_TYPE("Scan", TokenType::KW_SCAN),
        CHECK_SEMANTIC_TYPE("scan", TokenType::KW_SCAN),
        CHECK_SEMANTIC_TYPE("SAMPLE", TokenType::KW_SAMPLE),
        CHECK_SEMANTIC_TYPE("Sample", TokenType::KW_SAMPLE),
        CHECK_SEMANTIC_TYPE("sample", TokenType::KW_SAMPLE),
        ...
        CHECK_SEMANTIC_TYPE("Guest", TokenType::KW_GUEST),
        CHECK_SEMANTIC_TYPE("guest", TokenType::KW_GUEST),
        CHECK_SEMANTIC_TYPE("SST", TokenType::KW_SST),
        CHECK_SEMANTIC_TYPE("Sst", TokenType::KW_SST),
        CHECK_SEMANTIC_TYPE("sst", TokenType::KW_SST),
        ...
        CHECK_SEMANTIC_TYPE("ttl_col", TokenType::KW_TTL_COL),
        CHECK_SEMANTIC_TYPE("Ttl_col", TokenType::KW_TTL_COL),
        CHECK_SEMANTIC_TYPE("ACTIVE_VERSION", TokenType::KW_ACTIVE_VERSION),
        CHECK_SEMANTIC_TYPE("active_version", TokenType::KW_ACTIVE_VERSION),
        CHECK_SEMANTIC_TYPE("Active_version", TokenType::KW_ACTIVE_VERSION),
        CHECK_SEMANTIC_TYPE("MAX_VERSION", TokenType::KW_MAX_VERSION),
        CHECK_SEMANTIC_TYPE("max_version", TokenType::KW_MAX_VERSION),
        CHECK_SEMANTIC_TYPE("Max_version", TokenType::KW_MAX_VERSION),
        CHECK_SEMANTIC_TYPE("MIN_VERSION", TokenType::KW_MIN_VERSION),
        CHECK_SEMANTIC_TYPE("min_version", TokenType::KW_MIN_VERSION),
        CHECK_SEMANTIC_TYPE("Min_version", TokenType::KW_MIN_VERSION),
        CHECK_SEMANTIC_TYPE("LATEST_SECONDS", TokenType::KW_LATEST_SECONDS),
        CHECK_SEMANTIC_TYPE("latest_seconds", TokenType::KW_LATEST_SECONDS),
        CHECK_SEMANTIC_TYPE("Latest_seconds", TokenType::KW_LATEST_SECONDS),
        CHECK_SEMANTIC_TYPE("RESERVE_VERSIONS", TokenType::KW_RESERVE_VERSIONS),
        CHECK_SEMANTIC_TYPE("reserve_versions", TokenType::KW_RESERVE_VERSIONS),
        CHECK_SEMANTIC_TYPE("Reserve_versions", TokenType::KW_RESERVE_VERSIONS),
        ...
        CHECK_SEMANTIC_TYPE("configs", TokenType::KW_CONFIGS),
        CHECK_SEMANTIC_TYPE("Configs", TokenType::KW_CONFIGS),
        CHECK_SEMANTIC_TYPE("OPTIONS", TokenType::KW_OPTIONS),
        CHECK_SEMANTIC_TYPE("options", TokenType::KW_OPTIONS),
        CHECK_SEMANTIC_TYPE("Options", TokenType::KW_OPTIONS),
