...
DEFINE_string(stdout_log_file, "storaged-stdout.log", "Destination filename of stdout");
DEFINE_string(stderr_log_file, "storaged-stderr.log", "Destination filename of stderr");
